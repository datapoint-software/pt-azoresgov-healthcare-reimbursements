...
{
    public sealed class ProcessPatientCaptureOptionsPatientResultModel
    {
        public ProcessPatientCaptureOptionsPatientResultModel(Guid id, Guid rowVersionId, string name, DateTimeOffset? birth, Gender? gender, string healthNumber, string taxNumber, string addressLine1, string? addressLine2, string? addressLine3, string? postalCode, string? postalCodeArea, string? emailAddress, string? faxNumber, string? mobileNumber, string? phoneNumber, DateTimeOffset? death)
        {
            Id = id;
