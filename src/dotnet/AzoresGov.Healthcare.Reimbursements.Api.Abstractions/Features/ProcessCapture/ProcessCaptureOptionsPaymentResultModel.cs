...
{
    public sealed class ProcessCaptureOptionsPaymentResultModel
    {
        public ProcessCaptureOptionsPaymentResultModel(Guid? processPaymentConfigurationRowVersionId, Guid? processPaymentWireTransferConfigurationRowVersionId, PaymentMethod method, PaymentReceiver receiver, string? iban, string? swift)
        {
