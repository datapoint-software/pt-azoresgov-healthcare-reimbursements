...
{
    public sealed class MainProcessCaptureFeatureLegalRepresentativeModel
    {
        public MainProcessCaptureFeatureLegalRepresentativeModel(Guid id, Guid rowVersionId, string taxNumber, string name, string? faxNumber, string? mobileNumber, string? phoneNumber, string? emailAddress, string postalAddressArea, string postalAddressAreaCode, string postalAddressLine1, string? postalAddressLine2, string? postalAddressLine3)
        {
            Id = id;
