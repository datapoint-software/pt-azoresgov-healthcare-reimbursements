...
{
    public sealed class MainProcessCreationEntitySelectionSearchQueryHandler : IQueryHandler<MainProcessCreationEntitySelectionSearchQuery, MainProcessCreationEntitySelectionSearchResult>
    {
        ...
        public MainProcessCreationEntitySelectionSearchQueryHandler(IEntityRepository entities, IEntityParentEntityRepository entityParentEntities, IUserRepository users)
        {
            _entities = entities;
        ...
        public async Task<MainProcessCreationEntitySelectionSearchResult> HandleQueryAsync(MainProcessCreationEntitySelectionSearchQuery query, CancellationToken ct)
        {
            ...
            return new MainProcessCreationEntitySelectionSearchResult(
                totalMatchCount,
                entities
                    .Select(e => e.PublicId)
                    .ToArray(),
                entities
                    .Select(e => new MainProcessCreationEntitySelectionSearchResultEntity(
                        e.PublicId,
                        e.RowVersionId,
                        ...
                        e.Name,
                        e.Nature))
                    .Union(parentEntities.Values.Select(e => new MainProcessCreationEntitySelectionSearchResultEntity(
                        e.PublicId,
                        e.RowVersionId,
                        null,
                        e.Code,
