...
{
    /// <inheritdoc />
    public partial class ProcessPatients : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "ProcessPatients",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessPatients", x => x.Id);
                    table.UniqueConstraint("AK_ProcessPatients_PublicId", x => x.PublicId);
                    table.ForeignKey(
                        name: "FK_ProcessPatients_Processes_ProcessId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcessPatients_EmailAddress",
                table: "ProcessPatients",
                column: "EmailAddress");

            migrationBuilder.CreateIndex(
                name: "IX_ProcessPatients_HealthNumber",
                table: "ProcessPatients",
                column: "HealthNumber");

            migrationBuilder.CreateIndex(
                name: "IX_ProcessPatients_MobileNumber",
                table: "ProcessPatients",
                column: "MobileNumber");

            migrationBuilder.CreateIndex(
                name: "IX_ProcessPatients_Name",
                table: "ProcessPatients",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_ProcessPatients_PhoneNumber",
                table: "ProcessPatients",
                column: "PhoneNumber");

            migrationBuilder.CreateIndex(
                name: "IX_ProcessPatients_ProcessId",
                table: "ProcessPatients",
                column: "ProcessId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProcessPatients_TaxNumber",
                table: "ProcessPatients",
                column: "TaxNumber");
        }
