...
{
    public sealed class MainProcessCreationPatientSelectionFeatureSearchResultPatient
    {
        public MainProcessCreationPatientSelectionFeatureSearchResultPatient(Guid id, Guid rowVersionId, string number, string? taxNumber, string name, DateTimeOffset? birth, DateTimeOffset? death, bool external, string? faxNumber, string? mobileNumber, string? phoneNumber, string? emailAddress, string? postalAddressArea, string? postalAddressAreaCode, string? postalAddressLine1, string? postalAddressLine2, string? postalAddressLine3)
        {
            Id = id;
