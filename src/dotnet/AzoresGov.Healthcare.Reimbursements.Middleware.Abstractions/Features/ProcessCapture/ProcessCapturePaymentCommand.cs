...
{
    public sealed class ProcessCapturePaymentCommand : Command<ProcessCapturePaymentResult>
    {
        public ProcessCapturePaymentCommand(Guid userId, Guid processId, Guid processRowVersionId, Guid? processPaymentConfigurationRowVersionId, Guid? processPaymentWireTransferConfigurationRowVersionId, PaymentMethod method, PaymentReceiver receiver, string? iban, string? swift)
        {
            UserId = userId;
            ProcessId = processId;
